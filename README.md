# BTRMC
Мой модпак нацелен на оптимизацию игры и её украшение, старается сделать игру на серверах комфортнее. 

Версия - 1.16.5, загрузчик модов - Fabric (Forge-версию делать не буду).

Моды для сборки делаю не я, иногда могут случаться баги и конфликты - о таковых рапортуйте, пожалуйста, во вкладку "issues" =)
**Необходима версия JDK 11! (Рекомендую AdoptOpenJDK11 или OpenJDK11)

При первом заходе в ваш старый мир может случиться краш - это нормально, но **я рекомендую сделать бэкап мира** перед заходом на него с этой сборки.

Модпак содержит некоторые нестабильные и/или **WIP** моды, так что, как говорится, *"here be dragons"* - будьте осторожны со своими мирами :)

Шейдеры поддерживаются (Iris)! Для большей информации см. "Основные бинды".

### Заметка
Если вы сталкиваетесь с "Z-fighting"-ом (перекрытие и "драка" текстур), как на картинке - ![image](https://user-images.githubusercontent.com/76217453/132684617-cfd48c9e-a824-4a36-9e08-725c71991ae8.png)
- рекомендую установить следующий ресурспак: https://www.planetminecraft.com/texture-pack/no-z-fighting/
Некоторые моды в моей сборке могут вызывать подобный баг, но этот текстурпак способен исправить его.

## Краткая инструкция по установке: 
*1. Устанавливаете Fabric на версию 1.16.5*

*2. Скачиваете этот .zip архив (зелёная кнопка "Code" > "Download ZIP")*

*3. Распаковываете содержимое архива в папку версии 1.16.5 с установленным Fabric-ом*
